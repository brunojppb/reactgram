  ...
  return (
    <HomePage>
      ...
      <form onSubmit={onSubmit}>
        ...
        <input type="password" className="form-control" name="password" placeholder="Password" required onChange={onChange}/>
        <input type="submit" className="btn btn-primary btn-block" value="Login" disabled={isSubmitting}/>
      </form>
      <h2 className="subtitle center grid-divider">OR</h2>
      <Link to={Routes.INDEX} className="btn btn-primary btn-block">Create an account</Link>
    </HomePage>
  );
};