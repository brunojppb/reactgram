...
export const UserListPage = ({ title, fetchAction }) => {
  ...
  const [{ users, isLoading }, setState] = useState({
    users: [],
    isLoading: false,
  })
...
export const FollowersPage = () => {
  ...
  return <UserListPage title="Followers" fetchAction={fetchFollowers} />
}

export const FollowingPage = () => {
  const fetchFollowing = useCallback(getFollowing, [])
  return <UserListPage title="Following" fetchAction={fetchFollowing} />
}
